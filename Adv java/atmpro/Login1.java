...
public class Login1 extends Frame implements ActionListener{
    ...
    Login1(){
            ...
            try{
                 ...
                 con = DriverManager.getConnection("Jdbc:Odbc:ATMINFO");
            }catch(Exception ex){
    ...
    public void paint(Graphics g){
        ...
        g.drawString("Login1 Form", 100, 80);
          ...
          try{
              ...
              while(rs.next()){
                  ...
                  if(pass.equalsIgnoreCase(s2)){
                      JOptionPane.showMessageDialog(null, "You have Login1 Successfullyy !!!!","Message",JOptionPane.INFORMATION_MESSAGE);
